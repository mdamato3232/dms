...
class TransmissionsTable(tables.Table):
    ...
    link_id = tables.Column()
    analysis_state = tables.Column()
    first_timestamp_gmt = tables.Column()
    first_timestamp_local = tables.Column()
    latest_timestamp_gmt = tables.Column()
    latest_timestamp_local = tables.Column()
